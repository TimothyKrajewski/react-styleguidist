...
const PreviewComponent = (function(_Component) {
	...
	function PreviewComponent() {
		...
		const _this = _possibleConstructorReturn(
			this,
			(PreviewComponent.__proto__ || Object.getPrototypeOf(PreviewComponent)).call(this)
		);
...
const Preview = (function(_Component2) {
	_inherits(Preview, _Component2);

	function Preview() {
		let _ref;

		let _temp, _this2, _ret;
