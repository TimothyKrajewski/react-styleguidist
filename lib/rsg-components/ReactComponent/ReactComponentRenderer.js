...
export function ReactComponentRenderer(_ref2) {
	...
	return React.createElement(
		...
		React.createElement(
			...
			pathLine && React.createElement(Pathline, null, pathLine)
		),
		(description || docs) &&
			React.createElement('div', { className: classes.docs }, description, docs),
		tabButtons &&
			React.createElement(
				'div',
				...
				React.createElement(
					...
					React.createElement(Props, { props: tabButtons.props.props.props.props })
				),
				tabBody
			),
		examples
