...
const ReactComponent = (function(_Component) {
	...
	function ReactComponent(props, context) {
		...
		const _this = _possibleConstructorReturn(
			this,
			(ReactComponent.__proto__ || Object.getPrototypeOf(ReactComponent)).call(this, props, context)
		);

		const showUsage = context.config.showUsage;
	...
	_createClass(ReactComponent, [
		...
		},
		{
			...
			value: function render() {
				...
				const isolatedComponent = this.context.isolatedComponent;
				...
				return React.createElement(ReactComponentRenderer, {
					...
					examples:
						examples.length > 0
							? React.createElement(Examples, { examples, name })
							: React.createElement(ExamplePlaceholder, { name }),
