...
const Playground = (function(_Component) {
	...
	function Playground(props, context) {
		...
		const _this = _possibleConstructorReturn(
			this,
			(Playground.__proto__ || Object.getPrototypeOf(Playground)).call(this, props, context)
		);
	...
	_createClass(Playground, [
		...
		},
		{
			...
			value: function render() {
				...
				const isolatedExample = this.context.isolatedExample;

				const preview = React.createElement(Preview, { code, evalInContext });
				if (settings.noeditor) {
					return React.createElement(Para, null, preview);
				}
