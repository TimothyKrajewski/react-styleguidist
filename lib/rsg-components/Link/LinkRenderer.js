...
export function LinkRenderer(_ref2) {
	var classes = _ref2.classes,
	    ...
	    props = _objectWithoutProperties(_ref2, ['classes', 'section', 'children']);

	var location = window.location.href.split('#')[1];
	var slug = props.href.split('#')[1];
	var retVal = React.createElement(
		'a',
		_extends({}, props, { className: cx(slug === location ? section ? classes.onNow : "" : classes.link, classes.link, props.className, classes.itemHover) }),
		' ',
		children,
		' '
	);
