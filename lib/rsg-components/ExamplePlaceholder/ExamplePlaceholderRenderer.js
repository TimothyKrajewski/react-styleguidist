...
export var ExamplePlaceholderRenderer = (function(_Component) {
	...
	function ExamplePlaceholderRenderer() {
		...
		const _this = _possibleConstructorReturn(
			this,
			(ExamplePlaceholderRenderer.__proto__ || Object.getPrototypeOf(ExamplePlaceholderRenderer)
			).call(this)
		);
				...
				if (isVisible) {
					return React.createElement(Markdown, {
						text:
							'\nCreate **Readme.md** or **' +
							name +
							'.md** file in the component\u2019s folder like this:\n\n    ' +
							name +
							' example:\n\n    ```js\n    &lt;' +
							name +
							' pizza="&#x1f355;" /&gt;\n\t```\n\nYou may need to **restart** the style guide server after adding an example file.\n\nRead more in the [documenting components guide](' +
							DOCS_DOCUMENTING +
							').\n\t\t\t\t\t',
					});
				}
