...
function renderDefault(prop) {
	if (prop.required) {
		return React.createElement(Text, null, 'Required');
...
function renderDescription(prop) {
	...
	return React.createElement(
		...
		args.length > 0 && React.createElement(Arguments, { args, heading: true })
	);
}
...
function renderUnion(prop) {
	...
	const values = getType(prop).value.map(function(value, index) {
